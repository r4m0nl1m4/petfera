...
Mamifero_Exotico::Mamifero_Exotico(int id,
                    ...
                    : Mamifero(id,
                            ...
                            nome_batismo,
                            cor_do_pelo)
                    , Animal_Exotico(pais_de_origem,
                                    autorizacao_ibama){}

Mamifero_Exotico::~Mamifero_Exotico() { /*Usaremos o destrutor padrão*/ }

string Mamifero_Exotico::get_naturalidade() {return "Exotico"; }
string Mamifero_Exotico::get_legalidades(){ return this->get_especificacoes_legais(); }